      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 sm:pt-6 gap-3 sm:gap-0">
            ...
            >
              <Button
                ...
                className="bg-transparent text-white border border-white hover:bg-white/10 rounded-full px-4 sm:px-6 py-2 text-xs sm:text-sm font-medium transition-all duration-200 touch-manipulation min-h-[44px]"
              >
                VIEW ALL
              </Button>
            </motion.div>
        ...
        <div className="relative flex items-center justify-center gap-2 sm:gap-4 lg:gap-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
            className="relative w-full max-w-4xl aspect-video rounded-lg overflow-hidden group cursor-pointer touch-manipulation"
