      ...
      <div className="relative h-full flex items-end pb-20 px-4 sm:px-8 lg:px-12">
        <div className="space-y-6 max-w-2xl animate-fade-in">
          <div className="relative">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter relative z-10">
              NEL NGABO
            </h1>
            {/* Glitch effect text shadow */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter absolute top-0 left-0 opacity-50 text-gray-medium" style={{ transform: 'translate(2px, 2px)' }} aria-hidden="true">
              NEL NGABO
            </h1>
          </div>
