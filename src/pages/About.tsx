            ...
            >
              <div className="border border-white/10 bg-black/80 backdrop-blur-xl rounded-lg p-4 sm:p-6 md:p-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  {/* Top Row - Image and Biography Text */}
                  ...
                  {/* Bottom Row - Record Label and Discography - Same Line */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    {/* Discography */}
                    <div className="border border-white/10 bg-black/80 backdrop-blur-xl rounded-lg p-4 sm:p-6">
                      <h3 className="text-base sm:text-lg font-bold tracking-[0.1em] text-white uppercase mb-3 md:mb-4 eagle-lake">
                        Discography
                      </h3>
